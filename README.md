# JavaScript Learning & Solo Projects

This repository contains a collection of standalone solo projects that I built while learning **JavaScript**.

The goal of this repository is to track my personal growth, apply core theoretical concepts in practice (DOM manipulation, Async/Await, working with APIs, Event Handling, etc.), and build a solid foundation for web development.
...
| :---------------------------------------------------------------------------- | :----------------------------------------------- | :-----------------------------: | --------------------------------------------------------- | ------------ |
| [Digital Clock](https://histeria13.github.io/JS/digitalClock/)                | [./digitalClock/](./digitalClock/)               | Real-time digital clock display | DOM manipulation, Centered layout using Flexbox, `Date()` | ✅ Completed |
...
| [Wikipedia Search](https://histeria13.github.io/JS/searchWikipedia/)          | [./searchWikipedia/](./searchWikipedia/)         |        Wikipedia Search         | API, async, `classList`, theme toggle                     | ✅ Completed |
